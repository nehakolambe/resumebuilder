  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Work Experience<a href="add_work.php"><i class="fa fa-plus fa-fw w3-right w3-large w3-text-teal"></i></a></h2>
          <?php 
          ...
          $result = $conn->query($sql);
           while($row = $result->fetch_assoc()) {
            ...
            ?>
            <p>
            <a href="edit_work.php?edit=<?php echo $row["id"]; ?>">
            <i class="fa fa-edit fa-fw w3-right w3-large w3-text-teal"></i>
          </a>
          <a href="index.php?del=<?php echo $row["id"]; ?>">
            <i class="fa fa-remove fa-fw w3-right w3-large w3-text-teal"></i>
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $row["workname"]. " / ". $row["workmail"]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $row["startdate"]; ?> - <span class="w3-tag w3-teal w3-round"><?php echo $row["enddate"]; ?></span></h6>
          ...
          <hr>
            ...
            if(isset($_GET['del'])){
              $del_id = $_GET['del'];
              $sql = "DELETE FROM work WHERE id=$del_id";
              if(mysqli_query($conn,$sql)){
                echo "<script>window.location='index.php';</script>";
         } 
            }
      ...
      <div class="w3-container w3-card w3-white">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-certificate fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Education<a href="add_edu.php"><i class="fa fa-plus fa-fw w3-right w3-large w3-text-teal"></i></a></h2>
        <?php 
          ...
          $result = $conn->query($sql);
           while($row = $result->fetch_assoc()) {
            ...
            ?>
            <p>
            <a href="edit_edu.php?edit=<?php echo $row["id"]; ?>">
            <i class="fa fa-edit fa-fw w3-right w3-large w3-text-teal"></i>
          </a>
          <a href="index.php?del=<?php echo $row["id"]; ?>">
            <i class="fa fa-remove fa-fw w3-right w3-large w3-text-teal"></i>
        ...
        <div class="w3-container">
          <h5 class="w3-opacity"><b><?php echo $row["eduname"]; ?></b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $row["startdate"]. " - ".$row["enddate"]; ?></h6>
          <p><?php echo $row["detail"]; ?></p>
          <hr>
        </div>
            <?php }

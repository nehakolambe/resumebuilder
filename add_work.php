  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      if(isset($_POST['addwork'])){
         ...
         $sql = "INSERT INTO work VALUES (NULL,'$fname','$mail','$stdate','enddate','$wdetail')";
         if(mysqli_query($conn,$sql)){
          echo "<script>window.location='index.php';</script>";
         }
      }
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Add Work</h2>
        <form class="w3-container w3-card-4" action="" method="Post">
          ...
          <input class="w3-input w3-border" name="wname" type="text"></p>
          <p>      
          <label class="w3-text-blue"><b>Work Mail</b></label>
          <input class="w3-input w3-border" name="wmail" type="email"></p>
          <p>
          <p>      
          ...
          <p>      
          <button class="w3-btn w3-blue" name="addwork">Add</button></p>
        </form>
      </div>

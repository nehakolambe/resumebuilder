  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      if(isset($_POST['addlang'])){
         ...
         $sql = "INSERT INTO languages VALUES (NULL,'$name','$level')";
         if(mysqli_query($conn,$sql)){
          echo "<script>window.location='index.php';</script>";
         }
      }
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <form class="w3-container w3-card-4" action="" method="Post">
          ...
          <input class="w3-input w3-border" name="lname" type="text"></p>
          <p>      
          <label class="w3-text-blue"><b>Language Level</b></label>
          <input class="w3-input w3-border" name="level" type="number"></p>
          <p>      
          <button class="w3-btn w3-blue" name="addlang">Add</button></p>
        </form>
      </div>

  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      if(isset($_POST['updatework'])){
         ...
         $stdate = $_POST['sdate'];
         $enddate = $_POST['edate'];
         $wdetail = $_POST['detail'];
         $sql = "UPDATE work SET workname = '$fname', workmail = '$mail' , startdate = '$stdate' , enddate = '$enddate' , detail = '$wdetail' WHERE id = $edit_id";
         if(mysqli_query($conn,$sql)){
          echo "<script>window.location='index.php';</script>";
         }
      }
      $sql= "SELECT * FROM work WHERE id=$edit_id";
          $result = $conn->query($sql);
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Edit Work</h2>
        <form class="w3-container w3-card-4" action="" method="Post">
          <h2 class="w3-text-blue">Input Form</h2>
          <p>      
          <label class="w3-text-blue"><b>Work Name</b></label>
          <input class="w3-input w3-border" name="wname" type="text" value="<?php echo $row['workname'];?>"></p>
          <p>      
          <label class="w3-text-blue"><b>Work Mail</b></label>
          <input class="w3-input w3-border" name="wmail" type="email" value="<?php echo $row['workmail'];?>"></p>
          <p>
          <p>      
          <label class="w3-text-blue"><b>Start Date</b></label>
          <input class="w3-input w3-border" name="sdate" type="text" value="<?php echo $row['startdate'];?>"></p>
          <p>
          <p>      
          <label class="w3-text-blue"><b>End Date</b></label>
          <input class="w3-input w3-border" name="edate" type="text" value="<?php echo $row['enddate'];?>"></p>
          <p>
          <p>      
          <label class="w3-text-blue"><b>Detail</b></label>
          <input class="w3-input w3-border" name="detail" type="text" value="<?php echo $row['detail'];?>"></p>
          <p>      
          <button class="w3-btn w3-blue" name="updatework">Update</button></p>
        </form>
      </div>

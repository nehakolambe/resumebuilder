  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      if(isset($_POST['updateedu'])){
         ...
         $sql = "UPDATE education SET eduname = '$name', startdate = '$stdate' , enddate = '$enddate' , detail = '$edetail' WHERE id = $edit_id";
         if(mysqli_query($conn,$sql)){
          echo "<script>window.location='index.php';</script>";
         }
      }
      $sql= "SELECT * FROM education WHERE id=$edit_id";
      $result = $conn->query($sql);
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <form class="w3-container w3-card-4" action="" method="Post">
          ...
          <input class="w3-input w3-border" name="ename" type="text" value="<?php echo $row['eduname'];?>"></p>
          <p>
          <p>      
          ...
          <p>      
          <button class="w3-btn w3-blue" name="updateedu">Update</button></p>
        </form>
      </div>
